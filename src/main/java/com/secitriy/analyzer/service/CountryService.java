...
/**
 * Service Interface for managing {@link com.secitriy.analyzer.domain.Country}.
 */
public interface CountryService {
    ...
    /**
     * Get all the Country where UserAttributes is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<Country> findAllWhereUserAttributesIsNull();

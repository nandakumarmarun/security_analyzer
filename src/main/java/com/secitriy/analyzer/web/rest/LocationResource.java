...
/**
 * REST controller for managing {@link com.secitriy.analyzer.domain.Location}.
 */
@RestController
...
public class LocationResource {
    ...
    public List<Location> getAllLocations(
        ...
        if ("userattributes-is-null".equals(filter)) {
            log.debug("REST request to get all Locations where userAttributes is null");
            return locationService.findAllWhereUserAttributesIsNull();
        }

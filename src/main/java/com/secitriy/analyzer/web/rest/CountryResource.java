...
/**
 * REST controller for managing {@link com.secitriy.analyzer.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public List<Country> getAllCountries(@RequestParam(name = "filter", required = false) String filter) {
        if ("userattributes-is-null".equals(filter)) {
            log.debug("REST request to get all Countrys where userAttributes is null");
            return countryService.findAllWhereUserAttributesIsNull();
        }

...
/**
 * REST controller for managing {@link com.secitriy.analyzer.domain.District}.
 */
@RestController
...
public class DistrictResource {
    ...
    public List<District> getAllDistricts(
        ...
        if ("userattributes-is-null".equals(filter)) {
            log.debug("REST request to get all Districts where userAttributes is null");
            return districtService.findAllWhereUserAttributesIsNull();
        }
